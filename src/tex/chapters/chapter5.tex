...
\multicolumn{4}{|c|}{\textbf{Results}}                                                                                                                                                                                              \\ \hline
  ...
  \begin{tabular}[c]{@{}l@{}}Sophisticated\\ sample size(5-15)\end{tabular} & \begin{tabular}[c]{@{}l@{}}CDDCCDDDCDCDCDDDCDCDCCCCDCDDDCCC\\ DCDDDCDCDDCCDCDCCCDDCDDCCCDCCDDC\end{tabular} & 201 & 0.769231               \\ \hline
  \begin{tabular}[c]{@{}l@{}}Sophisticated\\ sample size(15-50)\end{tabular}& \begin{tabular}[c]{@{}l@{}}DDDCCDDCCCCCDCCDDDCCCCCDDCCDDCDCC\\ CDDCDCDCDDCCCDCCCDCCCDDCDDDDDCD\end{tabular} & 148 & 0.6875                  \\ \bottomrule
\end{tabular}
\end{adjustbox}
...
\begin{figure}[H]
	...
	\begin{subfigure}[H]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{chapter-five/line-plot-1.pdf}
		\caption{Deterministic}
	\end{subfigure}
	\hfill
	\begin{subfigure}[H]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{chapter-five/line-plot-2.pdf}
		\caption{Sophisticated Size 10-15}
	\end{subfigure}
  \hfill
  \begin{subfigure}[H]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{chapter-five/line-plot-3.pdf}
...
\multicolumn{4}{|c|}{\textbf{Results}}                                                                                                                                                                                             \\ \hline
                                     & lookup values  & generation   & score                                                                                                                                              \\ \hline
\begin{tabular}[c]{@{}l@{}}Sophisticated\\ sample size(5-15)\end{tabular}   & \begin{tabular}[c]{@{}l@{}}DDDDDCCDCDCDDCCDCCDDCCCDDCDCDCDC\\ CCCCCCDCDCDDDDCCDCDCDDDDDCDDDDCD\end{tabular} & 47 & 0.692308                  \\ \hline
...
\begin{tabular}[c]{@{}l@{}}Sophisticated\\ sample size(15-50)\end{tabular}& \begin{tabular}[c]{@{}l@{}}CDCCDDCDDDCCCDDDDCDCDCCDDCDCCDDD\\ DCDCCDCCCDDDCDDCDCDCDDCCCCCCDDDC\end{tabular} & 49 & 0.478261                     \\ \bottomrule
\end{tabular}
\end{adjustbox}
...
\begin{figure}[H]
	...
	\begin{subfigure}[H]{0.45\textwidth}
		\centering
		\includegraphics[width=\linewidth]{chapter-five/line-plot-4.pdf}
		\caption{Sophisticated Size 10-15}
	\end{subfigure}
  \hfill
  \begin{subfigure}[H]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{chapter-five/line-plot-5.pdf}
    \caption{Sophisticated Size 15-50}
  \end{subfigure}
...
\begin{table}[H]
  ...
  \begin{tabular}{cccccccccc}
      \toprule
\multicolumn{5}{|c|}{\textbf{Sophisticated Results}}                                                                                                                                       \\ \hline
