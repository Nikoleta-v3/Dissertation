...
from 19.30 to 1884.5. Concerning the graph measures, as explained in ~\ref{chap:Two},
...
This shows that in the lattice example the strategies tend to create groups, complete
subgraphs.
