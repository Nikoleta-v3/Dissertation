...
the spatial tournaments. In~\ref{lst:test_spatial_tournament}, we are testing
that the values of the attributes were passed correctly. Also that the score
is equal to what we anticipated. In~\ref{}, another test is shown. Here we are
testing that the results of a complete spatial tournament are equal to those
of a round robin one.
