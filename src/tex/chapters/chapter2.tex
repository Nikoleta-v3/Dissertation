...
the entire round robin tournament was repeated five times. 13 strategies were
...
Axelrod \cite{Axelrod1981} using the same set of strategies (64),
...
tournament which
consisted of 19 strategies, including a new set of strategies; the Zero-determinant
(ZD) strategies. The ZD are strategies for the stochastic IPD,
discovered by Press and Dyson in 2012 \cite{Press2012a}.
...
and what where the findings. Moreover, some research that has been generated the following
...
Further research was spawn in 1992 as to how the PD could shade
...
work on the topic on papers of his such as \cite{Nowak1993}.
...
findings, there is more cooperative behavior in a spatial structure tournament
...
spatial PD game model in which the neighborhood size was
